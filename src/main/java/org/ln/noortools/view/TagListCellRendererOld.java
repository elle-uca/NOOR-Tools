...
public class TagListCellRendererOld extends JPanel implements ListCellRenderer<AbstractTag> {

    private final JLabel iconLabel = new JLabel();
    private final JLabel titleLabel = new JLabel();
    private final JLabel tagLabel = new JLabel();

    public TagListCellRendererOld() {
    ...
    public Component getListCellRendererComponent(
        ...
        if (isSelected) {
            ...
            bg = UIManager.getColor("List.dropLineColor"); 
